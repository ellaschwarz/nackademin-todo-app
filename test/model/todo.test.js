...
describe('Testing the list model', () => {
	beforeEach(async function() {
        ...
        const todo = await todoModel.insertTodo(title, 'done', this.currentTest.userId, this.currentTest.listId);
	...
	it('should update a todo title', async function() {
		...
		//Act
		const updateTodo= await todoModel.updateTodo(this.test.todoId, title, 'done');
